...
public class WeatherController {
    ...
    public PointsDto getPointsDistance(@PathVariable String directions, @PathVariable String origin, @PathVariable int distance) throws InterruptedException {
    ...
    public PointsDto getPointsWithArrivalTime(@PathVariable String directions, @PathVariable String origin, @PathVariable int distance, @PathVariable int startTime) throws InterruptedException {
